...
public class Protocol {
	...
	public static final int SETTING = 400; // 세팅창 눌렀을 때
	public static final int SETNICK = 410; // 세팅창 눌렀을 때
	public static final int SETSTATUS = 420; // 세팅창 눌렀을 때
	public static final int SETIMG = 430; // 세팅창 눌렀을 때
	public static final int EXIT = 500; // 로그아웃
