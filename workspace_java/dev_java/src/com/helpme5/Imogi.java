 ...
 * 이모티콘
 */
public class Imogi extends JDialog implements ActionListener {
   ChatView cv = null;
   ...
   String imgFiles[] = { "lion11.png", "lion22.png", "lion33.png", "lion44.png", "lion55.png" };
   JButton imgButton[] = { jbtn_imo0, jbtn_imo1, jbtn_imo2, jbtn_imo3, jbtn_imo4 };
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if (obj == jbtn_imo0) {
         ...
         cv.message_process(null, imgChoice, null, null);
