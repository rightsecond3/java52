...
<script>
    ...
    function loginAction(){
		...
		$.ajax({
			method:"GET"
			,url:"/member/test.mo?crud=login&mem_id="+u_id+"&mem_pw="+u_pw
    ...
    function logoutAction(){
    	$.ajax({
			method:"GET"
			,url:"/onLineTest/logoutAccount.jsp"
			,success:function(data) {
				alert(data);
				$("#loginForm").html(data);
			}
...
<body>
	...
	<div class="container">
		<div class="jumbotron">
			...
			<p class="text-center">
				<a class="btn-primary btn-lg" href="lecture.html" role="button">강의
					들어 볼까?</a>
			</p>
		</div>
		<!-- =========================== 메인 이미지 다음 사이트 소개=====================-->
				...
				<div class="col-sm-4">
					<div class="media-left">
						<a href="lecture.html?lectureName=C"><img
							src="../../images/c.jpeg" width="50px" height="50px" alt="c언어"></a>
					</div>
					<div class="media-body">
						<h4 class="media-heading">
							<a href="lecture.html?lectureName=C">C언어 강의</a>&nbsp;<span
				...
				<div class="col-sm-4">
					<div class="media-left">
						<a href="lecture.html?lectureName=java"><img
							src="../../images/java.png" width="50px" height="50px" alt="c언어"></a>
					</div>
					<div class="media-body">
						<h4 class="media-heading">
							<a href="lecture.html?lectureName=C">JAVA 강의</a>&nbsp;<span
								class="badge">New</span>
						</h4>
						JAVA 프로그래밍 강의
					</div>
				...
				<div class="col-sm-4">
					<div class="media-left">
						<a href="lecture.html?lectureName=oracle"><img
							src="../../images/oracle.png" width="50px" height="50px"
							alt="c언어"></a>
					</div>
					<div class="media-body">
						<h4 class="media-heading">
							<a href="lecture.html?lectureName=oracle">Oracle 강의</a>&nbsp;<span
								class="badge">New</span>
						</h4>
						Oracle 데이터베이스 강의
					</div>
