...
<%@ include file="../common/JEasyUICommon.jsp" %>
	<script type="text/javascript">
		...
		function examStart() {
			...
			$.ajax({
				method : "GET"
				,url : "test.mo?crud=isOk&mem_id="+mem_id+"&exam_no="+examno
				,success : function(result) {
					if(result=="승인") {
					$.cookie('c_examno', examno);
						//문제지 정보를 가져온다.
...
<body>
	...
	<div class="easyui-panel" title="Test Take" style="width:100%;max-width:400px;padding:30px 30px">
		...
		<div style="margin-bottom:20px">
			<input class="easyui-textbox" id= "tb_examno" label="수험번호" labelPosition="left" style="width:200px">
		</div>
		<div>
